...
gsap.from(".tm-left > * *", {duration: .8, stagger: .10, keyframes: [{scale: 1.3, ease: "power1.outIn"}, {scale: 1}]});
gsap.set(".tm-right > * *", {transformOrigin: "center"});
gsap.set(".tm-right > * *", {scale: 0});
gsap.from(".tm-right > * *", {duration: .8, stagger: .10, keyframes: [{scale: 1.3, ease: "power1.outIn"}, {scale: 1}]});
//__sandwich
