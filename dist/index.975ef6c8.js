...
(0, _gsap.gsap).from(".intro-purple", {
    scrollTrigger: {
        trigger: ".intro-purple",
        start: "50px 80%",
        markers: true
    },
    duration: 2.5,
...
(0, _gsap.gsap).from(".gallery-top-purple", {
    scrollTrigger: {
        trigger: ".gallery-top-purple",
        start: "50px 80%",
        markers: true
    },
    duration: 2.5,
...
(0, _gsap.gsap).from(".gallery-mid-blue", {
    scrollTrigger: {
        trigger: ".gallery-mid-blue",
        start: "50px 80%",
        markers: true
    },
    duration: 2.5,
...
(0, _gsap.gsap).from(".gallery-mid-purple", {
    scrollTrigger: {
        trigger: ".gallery-mid-purple",
        start: "50px 80%",
        markers: true
    },
    duration: 2.5,
...
(0, _gsap.gsap).from(".gallery-btm-blue", {
    scrollTrigger: {
        trigger: ".gallery-btm-blue",
        start: "50px 80%",
        markers: true
    },
    duration: 2.5,
...
(0, _gsap.gsap).from(".gallery-btm-purple", {
    scrollTrigger: {
        trigger: ".gallery-btm-purple",
        start: "50px 80%",
        markers: true
    },
    duration: 2.5,
...
//menu timeline
(0, _gsap.gsap).set('.top-hex > *', {
    scale: 0,
    transformOrigin: "center"
});
(0, _gsap.gsap).set('.menu-shadow', {
    opacity: 0
});
...
function openModal(image) {
    ...
    if (image.classList.contains('active-slide')) getSlidePos(image);
    //
...
function getSlidePos(image) {
    ...
    for(let i = 0; i < slides.length; i++)if (i === selectedSlide) moveToSlide(track, slides[i]);
}
...
},{"gsap":"fPSuC","gsap/DrawSVGPlugin":"htWnw","gsap/ScrollTrigger":"7wnFk"}],"fPSuC":[function(require,module,exports,__globalThis) {
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"htWnw":[function(require,module,exports,__globalThis) {
/*!
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dyKFB","8lqZg"], "8lqZg", "parcelRequire94c2")
